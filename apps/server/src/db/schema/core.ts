import { pgTable, uuid, text, timestamp, pgEnum, varchar, boolean, numeric, jsonb } from 'drizzle-orm/pg-core';
...
export const transactionTypeEnum = pgEnum('transaction_type', ['sale', 'lease']);
...
export const clientTypeEnum = pgEnum('client_type', ['buyer', 'seller', 'tenant', 'landlord']);
export const coBrokingTypeEnum = pgEnum('co_broking_type', ['direct', 'co_broke']);
export const commissionTypeEnum = pgEnum('commission_type', ['percentage', 'fixed_amount']);
export const documentTypeEnum = pgEnum('document_type', ['agreement', 'kyc', 'payment_proof', 'title_deed', 'spa', 'moi', 'other']);
