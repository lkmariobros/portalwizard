...
import { RiHomeLine, RiBriefcaseLine, RiTeamLine, RiSettingsLine } from '@remixicon/react' // Example icons
...
const agentNavItems = [
  {
    ...
    items: [
      ...
      { title: 'My Transactions', href: '/agent/transactions', icon: RiBriefcaseLine },
  ...
  },
  {
    title: 'Settings',
    items: [
      { title: 'Profile', href: '/agent/profile', icon: RiSettingsLine },
    ]
  }
]
